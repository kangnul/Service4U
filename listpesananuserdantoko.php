...
<body>
    ...
    <div class="pb-4"></div>
		...
		include "koneksi.php";
		$username = $_REQUEST['userr'];
		$pesanan = "SELECT * FROM transactionheader WHERE usernamecustomer = '$username'";
                    ...
                    <div class='card-body'>
                        ...
                        <div class='flex-container'>
                            <div class='Lihat_Detail'>
                                <button class='btn btn-outline-dark'><a href = detailpesananuser.php?userr=$username&trid=$row[0]>Lihat Detail</a></button>
                            </div>
                        </div>
                    </div>
                </div>
