   ...
   <div class="container mt-5 ">
    ...
    <div class="row mt-3">
        <div class="col-sm-3" >
            <div class="card">
            	<center>
              <img src="images/<?php echo $row[12] ?>" class="card-img-top" alt="Sunset Over the Sea"/ >
              </center>
                  ...
                  <div class="card-header text-white" style = "background-color: #1E88E5;">
                    ...
                    <div class="card-body">
                      ...
                      <div class="row">
                        ...
                        <div class="col">
                            <div class = "text-muted" style = "font-size: 15px;">Rp --</div>
                        </div>
                      </div>
                        <!--show biaya admin-->
                        <div class="row">
                          ...
                          <div class="col">
                              <div class = "text-muted" style = "font-size: 15px;">Rp 15.000</div>
                        </div>
                      </div>
                        <!--show biaya pajak-->
                        <div class="row">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <table class="table table-striped ">
                        ...
                        <tbody>
                          <tr >
                            <td class = "text-muted" style = "font-size: 15px;">19 Maret 2023</td>
                            <td class = "text-muted" style = "font-size: 15px;">14:41:57</td>
                            <td class = "text-muted" style = "font-size: 15px;">USER mengirim barang ke toko</td>
                          </tr>
                          <tr >
                            <td class = "text-muted" style = "font-size: 15px;">20 Maret 2023</td>
                            <td class = "text-muted" style = "font-size: 15px;">13:29:05</td>
                            <td class = "text-muted" style = "font-size: 15px;">Toko melakukan perbaikan</td>
                          </tr>
                          <tr >
                            <td class = "text-muted" style = "font-size: 15px;">21 Maret 2023</td>
                            <td class = "text-muted" style = "font-size: 15px;">14:43:40</td>
                            <td class = "text-muted" style = "font-size: 15px;"> Pesanan diambil atas nama USER</td>
                          </tr>
                          <tr >
                            <td class = "text-muted" style = "font-size: 15px;">20 Maret 2023</td>
                            <td class = "text-muted" style = "font-size: 15px;">13:29:05</td>
              ...
              <div class="card mt-2">
                <button type="button" class="btn btn-outline-primary"  data-toggle="modal" data-target="#exampleModal" data-whatever="@mdo"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-plus-circle" viewBox="0 0 16 16">
                  <path d="M8 15A7 7 0 1 1 8 1a7 7 0 0 1 0 14zm0 1A8 8 0 1 0 8 0a8 8 0 0 0 0 16z"/>
                  <path d="M8 4a.5.5 0 0 1 .5.5v3h3a.5.5 0 0 1 0 1h-3v3a.5.5 0 0 1-1 0v-3h-3a.5.5 0 0 1 0-1h3v-3A.5.5 0 0 1 8 4z"/>
                </svg>Tambah Riwayat Pesanan</button>
            ...
            <div class="card ">
                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-6">
                            <div class = "text-muted" style = "font-size: 15px;"><?php echo $row[1] ?></div>
                        </div>
                    </div>
                    <!--TANGGAL-->
                    <div class="row">
                        ...
                        <div class="col-6">
                            <div class = "text-muted" style = "font-size: 15px;"><?php echo $row[7] ?></div>
                        </div>
                    </div>
                    <!--waktu pemesanan-->
                    <div class="row">
                        ...
                        <div class="col-6">
                            <div class = "text-muted" style = "font-size: 15px;"><?php echo $row[8] ?></div>
                        </div>
                    </div>
                    <!--Merk-->
                    <div class="row">
                        ...
                        <div class="col-6">
                            <div class = "text-muted" style = "font-size: 15px;"><?php echo $row[4] ?></div>
                        </div>
                    </div>
                    <!--Seri perangkat-->
                    <div class="row">
                        ...
                        <div class="col-6">
                            <div class = "text-muted" style = "font-size: 15px;"><?php echo $row[5] ?></div>
                        </div>
                    </div>
                    <!--Desc perangkat-->
                    <div class="row">
                        ...
                        <div class="col-6">
                            <div class = "text-muted" style = "font-size: 15px;"><?php echo $row[6] ?></div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-6">
                            <h6 style="color:blue" ><?php echo $row[9] ?></h6>
